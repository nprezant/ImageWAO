...
class IntroPage(QtWidgets.QWizardPage):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.pathEdit.textChanged.connect(lambda text: self._updateInvalidPathVisibility())
        ...
        self.invalidPathLabel = QtWidgets.QLabel('Please enter a valid folder path or choose one with the browse button')
